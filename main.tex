...
\begin{questions}
    ...
    \begin{solution}
        ...
        \end{align*}
        Die Randbedingungen werden zu $f_0(0) = 0$, $f_1(0) = 0$ sowie $f_1(\infty) = 1$ beziehungsweise $f_2(0) = z$. Der Code ist weiter dargestellt.
    \end{solution}
    ...
    \inputminted[breaklines, fontsize=\small, frame=single]{python}{blasius_equation.py}
    \begin{figure}[!htbp]
        \centering
