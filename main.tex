...
\begin{questions}
    ...
    \begin{solution}
        In weiser Voraussicht haben wir in der vorigen Aufgabe bereits das Argument der ersten Ableitung $f'$ zum Funktionswert $0.9$ bestimmt. Die Newtoniteration ergab den Wert $\eta \approx 4.9$. Wir wissen, dass 
        \begin{equation*}
