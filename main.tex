...
\begin{questions}
    ...
    \begin{solution}
        ...
        Wir sehen also, dass die Dispersionsrelation nun auch von der Viskosität und in gewisser Weise von der Größenordnung der Dichte abhängt.
    \end{solution}
    ...
    \begin{solution}
        {\color{red} TODO (Andi: Mach ich dann fertig - Danke Andi :) - Christina)}
    \end{solution}
